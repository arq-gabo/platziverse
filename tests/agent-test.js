...
test.beforeEach(async () => {
    ...
    AgentStub.create.withArgs(newAgent)
        .returns(Promise.resolve({ toJSON () { return newAgent }}));

    // Model findOne Stub
    AgentStub.findOne = sandbox.stub();
    AgentStub.findOne.withArgs(uuidArgs)
        .returns(Promise.resolve(agentFixture.byUuid(uuid)));
    ...
    AgentStub.findAll.withArgs()
        .returns(Promise.resolve(agentFixture.all));
    AgentStub.findAll.withArgs(connectedArgs)
        .returns(Promise.resolve(agentFixture.connected));
    AgentStub.findAll.withArgs(usernameArgs)
        .returns(Promise.resolve(agentFixture.platzi));
